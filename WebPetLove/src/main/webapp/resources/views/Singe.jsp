	...
	<div class="container" style="padding-top: 20px;">
			...
			<div class="categories animated wow slideInUp" data-wow-delay=".5s">
				...
				<ul class="cate">
					<c:forEach items="${category_givepet}" var="c">
						<li><a href="product/${c.catergoty_givepetid}">${c.categorynameGivepet} </a>
						</li>
					</c:forEach>
		...
		<div class="col-md-8 single-right">
			<div class="col-md-5 single-right-left animated wow slideInUp"
				data-wow-delay=".5s">
				<c:forEach items="${productsGivepet}" var="pgp">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="${pgp.productGivePetImage}">
							<div class="thumb-image">
								<img src="${pgp.productGivePetImage}" data-imagezoom="true"
		...
		<c:choose>
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
				<h3>${pgp.productGivePetName}</h3>
				<h4>
					<span class="item_price"><fmt:formatNumber
							value="${pgp.productGivePetPrice}" type="currency" currencySymbol="" />
						VNĐ</span>
				</h4>
				<div class="occasion-cart">
					<a class="item_add" style="cursor: pointer"
						onclick="addItem(${productGPId})">Thêm vào giỏ hàng </a>
				</div>
					...
					<div class="sendanhgia">
						...
						<p class="ratings">
							...
							<input type="hidden" name="id" value="${user.id}"> <input
								type="hidden" name="productID" value="${pgp.productGivePetID}">
				...
				<div class="description">
					...
					<p>${pgp.productGivePetDescription}</p>
				</div>
			...
			<div class="fb-comments"
				data-href="http://localhost:8080/shop/Single/${productGPId}"
