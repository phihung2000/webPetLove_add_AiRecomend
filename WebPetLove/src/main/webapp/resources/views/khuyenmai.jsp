...
<body>
<h3 class="animated wow zoomIn" data-wow-delay=".5s">Siêu Sale Trong Tuần </h3>
                                ...
                                <div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
                                    <div class="new-collections-grid1-image">
                                        <a href="single/${p.productID}" class="product-image">
                                        	<span class="sale" id ="sale">-50%</span>
                                    ...
                                    <div class="simpleCart_shelfItem products-right-grid1-add-cart">
                                         <p>
                                        	<span class="item_price" id="first_price"><fmt:formatNumber value="${p.productPrice}" type="currency" currencySymbol=""/>đ</span>
                                        	<span class="item_price" id ="final_price"><fmt:formatNumber value="${p.productPrice *0.5}" type="currency" currencySymbol=""/>đ</span>
